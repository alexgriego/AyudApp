<template>
    <div class="alert alert-warning alert-dismissible fade show" role="alert" v-if="!usuario.user.uid">
    ...
    <div class="card" v-else>
        <div class="card-body">
                    ...
                    <div class="mb-3">
                        <h3>Rol de usuario : {{
                            usuario.user.groups?.includes('Administrador' || 'Encuestador' || 'Bodeguista') ?
                                usuario.user.groups[0] : (usuario.user.is_superuser ? 'SuperUsuario' : 'Invitado') }} <i
            ...
            <div class="row">
                ...
                <div class="col col-lg-6">
                    <div class="mb-3">
                        <label for="address" class="form-label">Teléfono <i class="bi bi-phone"></i></label>
                        {{ usuario.user.phone }}
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col col-lg-6">
                    <div class="mb-3">
                        <label for="telefono" class="form-label">Correo <i class="bi bi-phone"></i></label>
                        {{ usuario.user.email }}
                    </div>
                </div>
                <div class="col col-lg-6">
                    <div class="mb-3">
                        <label for="direccion" class="form-label">Ciudad <i class="bi bi-map"></i></label </div>
                        {{ usuario.user.city }}
                    </div>
                </div>
            </div>
