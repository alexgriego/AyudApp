<template>
    <form @submit.prevent="handleSubmit">
        ...
        <div class="form-group">
            <label for="identificacion">Identificacón <i class="bi bi-person-vcard"></i></label>
            <div class="input-group input-group mb-3">
                <div class="input-group-prepend" id="identificacion" :required="!identificacion">
                ...
                <!-- /btn-group -->
                <input type="text" class="form-control" v-model="data.identificacion" :required="!identificacion">
            </div>
        </div>
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-border" id="nombre" name="nombre"
                        @input="handleChange" v-model="data.nombre" :required="!identificacion">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label for="apellido">Apellido <i class="bi bi-person-badge"></i></label>
                    <input type="text" class="form-control form-control-border" id="apellido" name="apellido"
                        @input="handleChange" v-model="data.apellido" :required="!identificacion">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label for="fecha_nacimiento">Fecha de nacimiento <i class="bi bi-person"></i></label>
                    <input type="date" class="form-control form-control-border" id="fecha_nacimiento"
                        name="fecha_nacimiento" @input="handleChange" v-model="data.fecha_nacimiento"
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control form-control-border" id="correo" name="correo"
                        @input="handleChange" v-model="data.correo">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-border" id="telefono" name="telefono"
                        @input="handleChange" v-model="data.telefono" :required="!identificacion">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-border" id="direccion" name="direccion"
                        @input="handleChange" v-model="data.direccion" :required="!identificacion">
                </div>
            </div>
        </div>
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-border" id="ciudad" name="ciudad"
                        @input="handleChange" v-model="data.ciudad" :required="!identificacion">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label for="departamento">Departamento/Estado <i class="bi bi-geo-alt"></i></label>
                    <input type="text" class="form-control form-control-border" id="departamento" name="departamento"
                        @input="handleChange" v-model="data.departamento" :required="!identificacion">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label for="pais">Pais <i class="bi bi-geo-alt"></i></label>
                    <input type="text" class="form-control form-control-border" id="pais" name="pais"
                        @input="handleChange" v-model="data.pais" :required="!identificacion">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control form-control-border" id="edad" name="edad"
                        @input="handleChange" v-model="data.edad" disabled>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
            ...
            <div class="col">
                <div class="form-group">
                    <label for="estado_civil">Estado civil <i class="bi bi-person"></i></label>
        ...
        <div class="form-group">
            <label for="observaciones">Observaciones <i class="bi bi-person"></i></label>
            <textarea class="form-control form-control-border" id="observaciones" name="observaciones"
                @input="handleChange" v-model="data.observaciones"></textarea>
        </div>
        <button type="submit" :class="props.data ? 'btn btn-warning' : 'btn btn-primary'">Procesar <i
...
const handleSubmit = (e: any) => {
    e.preventDefault();
    identificacion ? store.actualizarBeneficiario(identificacion, data.value) : store.crearBeneficiario(data.value)
}
</script>